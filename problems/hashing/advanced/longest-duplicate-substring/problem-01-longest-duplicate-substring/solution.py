...
if __name__ == "__main__":
    sol = Solution()
    print(sol.longestDupLength("banana"))  # expected: 3
    print(sol.longestDupLength("abcd"))  # expected: 0
    print(sol.longestDupLength("aaaaa"))  # expected: 4
    print(sol.longestDupLength("abcabcabc"))  # expected: 6
