...
if __name__ == "__main__":
    sol = Solution()
    print(sol.stringsEqual("abcdef", "abcdef"))  # expected: True
    print(sol.stringsEqual("abc", "abd"))  # expected: False
    print(sol.stringsEqual("abc", "abcd"))  # expected: False
    print(sol.stringsEqual("", ""))  # expected: True
