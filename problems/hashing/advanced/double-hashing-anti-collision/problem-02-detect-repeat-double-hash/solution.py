...
if __name__ == "__main__":
    sol = Solution()
    print(sol.hasRepeatOfLength("banana", 2))  # expected: True
    print(sol.hasRepeatOfLength("abcdef", 2))  # expected: False
    print(sol.hasRepeatOfLength("abcabc", 3))  # expected: True
    print(sol.hasRepeatOfLength("abcabc", 4))  # expected: False
