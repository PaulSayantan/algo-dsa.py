# Canonical Hash of a Rooted Tree — Solution
...
The returned canonical string is itself the deterministic key; comparing or bucketing these strings tests isomorphism without any numeric hashing.
