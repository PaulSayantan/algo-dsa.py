...
if __name__ == "__main__":
    sol = Solution()
    print(sol.areIsomorphic([-1, 0, 0], [1, -1, 1]))  # expected: True
    print(sol.areIsomorphic([-1, 0, 0], [-1, 0, 1]))  # expected: False
    print(sol.areIsomorphic([-1, 0, 0, 2], [3, 3, 1, -1]))  # expected: True
    print(sol.areIsomorphic([-1, 0, 0, 0], [-1, 0, 1, 2]))  # expected: False
