...
if __name__ == "__main__":
    sol = Solution()
    print(sol.countDuplicateSubtrees([1, 2, 3, 4, None, 2, 4, None, None, 4]))  # expected: 2
    print(sol.countDuplicateSubtrees([2, 1, 1]))  # expected: 1
    print(sol.countDuplicateSubtrees([1, 2, 3]))  # expected: 0
