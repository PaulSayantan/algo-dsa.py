...
if __name__ == "__main__":
    sol = Solution()
    print(sol.countDistinctSubtrees([1, 2, 3]))  # expected: 3
    print(sol.countDistinctSubtrees([2, 1, 1]))  # expected: 2
    print(sol.countDistinctSubtrees([4, 4, 4]))  # expected: 2
    print(sol.countDistinctSubtrees([]))  # expected: 0
