# Identical Trees via Serialization — Solution
...
`[1,2]` (left child) and `[1,None,2]` (right child) serialize differently, so structure — not just the multiset of values — is compared.
