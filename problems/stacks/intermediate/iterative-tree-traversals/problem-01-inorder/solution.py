...
if __name__ == "__main__":
    sol = Solution()
    print(sol.inorderTraversal(build([1, None, 2, 3])))  # expected: [1, 3, 2]
    print(sol.inorderTraversal(build([])))  # expected: []
    print(sol.inorderTraversal(build([1, 2, 3, 4, 5])))  # expected: [4, 2, 5, 1, 3]
